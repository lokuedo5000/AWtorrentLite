...
const autoCompleteJS = new autoComplete({
  ...
  data: {
    src: async function () {
      ...
      const source = await fetch("db/games.json");
  ...
  onSelection: (feedback) => {
    ...
    // document.querySelector(".searchs").setAttribute("data-tags", selection);
    document.querySelector("#btn-envio").click();
    // document.querySelector(".btnl_run_search").setAttribute("data-tags", selection);
    // document.querySelector(".btnl_run_search").click();
